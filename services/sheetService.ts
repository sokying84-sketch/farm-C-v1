...
// ----------------------------------------------------------------------------
// INSTRUCTIONS: PASTE YOUR DEPLOYED URLS BELOW TO SAVE THEM PERMANENTLY
// ----------------------------------------------------------------------------
const DEFAULT_SCRIPT_URL: string = ''; // e.g. 'https://script.google.com/macros/s/ABCD.../exec'
const DEFAULT_SHEET_URL: string = '';  // e.g. 'https://docs.google.com/spreadsheets/d/1234...'
// ----------------------------------------------------------------------------
...
export const saveAppSettings = (url: string, sheetUrl: string, useMock: boolean) => {
  // Only save to local storage if not hardcoded (or to override if needed, but getAppSettings prioritizes hardcode)
